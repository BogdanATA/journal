...
**Goal**: User can open the app to a blank page for today, write freely with entries automatically segmented by blank lines, trust that nothing is ever lost, and navigate to/edit/delete any past day — as a signed, installable native app on macOS and Windows with the dark, minimal notepad look.
**Mode:** mvp
...
|-------|----------------|--------|-----------|
| 1. Reliable Daily Writing & Navigation | 0/TBD | Not started | - |
